...
async def _(event):
    await event.edit(
        """
أوامر الصيد الخاصة بسورس مصطفي : 
...
@hn_pp  - channle userbot 

"""
    )


@mody.ar_cmd(pattern="صيد (.*)")
    ...
    try:
        ch = await mody(
            functions.channels.CreateChannelRequest(
                title="ZE HUNTER - صيد مصطفي",
                about="This channel to hunt username by - @hn_pp  ",
            )
        )
...
@mody.ar_cmd(pattern="ايقاف الصيد")
async def _(event):
    if "on" in isclaim:
        isclaim.clear()
        isclaim.append("off")
...
@mody.ar_cmd(pattern="ايقاف التثبيت")
async def _(event):
    if "on" in isauto:
        isauto.clear()
        isauto.append("off")
...
@mody.ar_cmd(pattern="حالة الصيد")
async def _(event):
    if "on" in isclaim:
...
@mody.ar_cmd(pattern="حالة التثبيت")
async def _(event):
    if "on" in isauto:
