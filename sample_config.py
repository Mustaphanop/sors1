...
class Config(object):
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/mustaphanop/sors1.git"
    )
    ...
    ZE_START = os.environ.get("ZE_START", None)
    PMPERMIT_TEXT_Ze = os.environ.get("PMPERMIT_TEXT_Ze", None)
    UB_BLACK_LIST_CHAT = {
    ...
    # specify NO_LOAD with plugin names for not loading in Ze
    ...
    # For updater plugin
    UPSTREAM_REPO_BRANCH = os.environ.get("UPSTREAM_REPO_BRANCH", "SourceZe")
